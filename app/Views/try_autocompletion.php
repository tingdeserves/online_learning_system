<!--Learning resource https://www.w3schools.com/howto/howto_js_autocomplete.asp-->
...
<!-- jQuery version autocompletion -->
<!-- learning resource:  https://jqueryui.com/autocomplete/   -->
...
<!-- get the course list array using AJAV -->
<script>
  var course_data;
  //$(document).ready( get_course_list);
